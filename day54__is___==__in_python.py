# -*- coding: utf-8 -*-
"""day54 "is" "==" in python.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NPWuxxnQMSx2T48DSxxtZNQFiR7NfaKZ

'is' vs '==' in Python

In Python ,is and == both comparison oparators that can vbe used to check if two values are equal. However , ther are some important diffrences between the two that you should be aware of.
...
"""In this case , a and b are two separate lists that have same values, so == returns True However , a and b are not the same object in memeory, so is returns False.
...
"""isn this case , a and b are both pointing to the same object in memory, so is and == both return  True.
